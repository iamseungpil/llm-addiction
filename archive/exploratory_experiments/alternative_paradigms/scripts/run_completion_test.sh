#!/bin/bash
# [SLURM-DISABLED] #SBATCH --job-name=completion_test
# [SLURM-DISABLED] #SBATCH --partition=cas_v100_4
# [SLURM-DISABLED] #SBATCH --output=/home/jovyan/llm-addiction/archive/exploratory_experiments/alternative_paradigms/logs/completion_test_%j.log
# [SLURM-DISABLED] #SBATCH --error=/home/jovyan/llm-addiction/archive/exploratory_experiments/alternative_paradigms/logs/completion_test_%j.err
...
ls -la /home/jovyan/beomi/llm-addiction-data/blackjack/ | tail -5
