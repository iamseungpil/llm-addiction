#!/usr/bin/env python3
"""Claude-3.5-Haiku Runner for Extended Investment Choice Experiment"""
...
class ClaudeRunner(BaseInvestmentExperiment):
    ...
    def __init__(self, bet_constraint, bet_type: str):
        super().__init__('claude_haiku', bet_constraint, bet_type)
    ...
    def get_model_response(self, prompt: str) -> str:
        """Get response from Claude-3.5-Haiku with retry logic"""
        attempt = 1
