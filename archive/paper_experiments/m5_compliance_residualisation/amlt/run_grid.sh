...
python archive/paper_experiments/m5_compliance_residualisation/src/extract_compliance_directions.py \
...
python archive/paper_experiments/m5_compliance_residualisation/src/compute_baseline_dp.py \
...
python archive/paper_experiments/m5_compliance_residualisation/src/residualise_sae_features.py \
...
python archive/paper_experiments/m5_compliance_residualisation/src/refit_table3_residualised.py \
...
python archive/paper_experiments/m5_compliance_residualisation/src/analyze_m5.py \
