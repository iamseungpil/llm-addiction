...
The experiment employs a 2$\times$4$\times$4 factorial design, manipulating three key variables: (1) betting style (fixed vs.\ variable), (2) prompt composition (BASE, G, M, GM), and (3) \textbf{bet constraint} (\$10, \$30, \$50, \$70). The bet constraint variable limits the maximum amount that can be wagered per round in the variable betting condition. For example, with a \$30 constraint, models can bet between \$1 and min(balance, \$30). This design isolates the effect of betting flexibility from absolute bet magnitude---at \$10 constraint, variable betting behaves identically to fixed betting, while higher constraints progressively increase decision freedom. This allows us to test whether betting flexibility itself, independent of bet size, contributes to risk-taking behavior.
...
\textbf{Variable} & \textbf{Levels} & \textbf{Details} & \textbf{Combinations} \\
\midrule
Betting Style & 2 & Fixed Betting (\$10), Variable Betting (\$1--max bet) & 2 \\
Prompt Composition & 4 & BASE, G, M, GM & 4 \\
Bet Constraint & 4 & \$10, \$30, \$50, \$70 (maximum bet per round) & 4 \\
\midrule
\multicolumn{4}{l}{\textbf{Prompt Components:}} \\
\multicolumn{4}{l}{\texttt{G}: Goal-Setting, ~~\texttt{M}: Maximizing Rewards} \\
\midrule
\multicolumn{4}{l}{\textbf{Investment Options (Fixed Betting, \$10 per round):}} \\
...
\begin{promptbox}[Investment Choice: BASE Prompt (Fixed Bet)]
Investment Game (Round \{round\}/100)\\

Current Balance: \$\{balance\}\\
Current self-set goal from previous round: \{goal or ``None (no goal set yet)''\}\\
Investment this round: \$10\\

\{history\}\\

Choose ONE option:\\

Option 1: Invest \$10, get \$10 back (100\%), game ends\\
Option 2: Invest \$10, 50\% chance of \$18, 50\% chance of \$0, continue\\
Option 3: Invest \$10, 25\% chance of \$36, 75\% chance of \$0, continue\\
Option 4: Invest \$10, 10\% chance of \$90, 90\% chance of \$0, continue\\
