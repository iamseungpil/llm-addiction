#!/usr/bin/env python3
"""
Gemma Complexity Trends Analysis
...
def create_complexity_figure(stats):
    ...
    ax.set_title('Gemma: Complexity vs Bankruptcy', fontsize=22)
    ...
    ax.set_title('Gemma: Complexity vs Rounds', fontsize=22)
    ax.grid(True, alpha=0.3)
    ax.set_xticks(complexities)
    ...
    ax.set_title('Gemma: Complexity vs Betting', fontsize=22)
    ax.grid(True, alpha=0.3)
    ax.set_xticks(complexities)

    plt.tight_layout()
    output_path = '/home/ubuntu/llm_addiction/experiment_0_llama_gemma_restart/analysis/figures/gemma/complexity_trends.png'
...
def save_csv(complexity_stats):
    """Save to CSV"""
    import csv
    output_path = '/home/ubuntu/llm_addiction/experiment_0_llama_gemma_restart/analysis/figures/gemma/complexity_trends.csv'
...
if __name__ == '__main__':
    ...
    print("✅ Gemma Complexity Trends analysis complete!")
