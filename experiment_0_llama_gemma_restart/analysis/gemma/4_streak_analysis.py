...
def create_streak_figure(results):
    ...
    ax.set_title('Gemma: Post-Streak Continuation', fontsize=22)
    ax.set_xticks(x_pos)
    ...
    ax.set_title('Gemma: Post-Streak Bet Increases', fontsize=22)
    ax.set_xticks(x_pos)
    ax.set_xticklabels(['2', '3', '4'])
    ax.legend()
    ax.grid(True, alpha=0.3, axis='y')
    ...
    plt.tight_layout()
    output_path = '/home/ubuntu/llm_addiction/experiment_0_llama_gemma_restart/analysis/figures/gemma/streak_analysis.png'
...
def save_csv(results):
    """Save to CSV"""
    import csv
    output_path = '/home/ubuntu/llm_addiction/experiment_0_llama_gemma_restart/analysis/figures/gemma/streak_analysis.csv'
...
if __name__ == '__main__':
    ...
    save_csv(results)
    print("✅ Gemma Streak Analysis complete!")
