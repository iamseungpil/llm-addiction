...
# Phase 4: Output Word-Feature Correlation Analysis (Full 2787 features)
...
echo "=== Phase 4 (FULL 2787 features): Word-Feature Correlation Launch ==="
echo "Analyzing word-feature relationships from Phase 1"
echo ""
...
for gpu in 5 6 7; do
    ...
    LOG_FILE="${LOG_DIR}/phase4_full_gpu${gpu}.log"
...
echo ""
echo "✅ Phase 4 (FULL) complete! All GPU word-feature correlations finished"
