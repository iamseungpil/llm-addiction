#!/usr/bin/env python3
"""
Gemma Component Effects Analysis
...
def create_component_figure(results):
    ...
    ax.set_title('Gemma: Component Effects on Bankruptcy', fontsize=24)
    ax.set_xticks(x_pos)
    ...
    ax.set_title('Gemma: Component Effects on Rounds', fontsize=24)
    ax.set_xticks(x_pos)
    ax.set_xticklabels([results[c]['name'].split()[0] for c in components])
    ax.grid(True, alpha=0.3, axis='y')
    ...
    ax.set_title('Gemma: Component Effects on Betting', fontsize=24)
    ax.set_xticks(x_pos)
    ax.set_xticklabels([results[c]['name'].split()[0] for c in components])
    ax.grid(True, alpha=0.3, axis='y')

    plt.tight_layout()
    output_path = '/home/ubuntu/llm_addiction/experiment_0_llama_gemma_restart/analysis/figures/gemma/component_effects.png'
...
def save_csv(results):
    """Save to CSV"""
    import csv
    output_path = '/home/ubuntu/llm_addiction/experiment_0_llama_gemma_restart/analysis/figures/gemma/component_effects.csv'
...
if __name__ == '__main__':
    ...
    save_csv(results)
    print("✅ Gemma Component Effects analysis complete!")
