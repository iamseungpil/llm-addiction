...
As reported in Table~\ref{tab:slot-machine-results}, variable betting consistently produced higher bankruptcy rates than fixed betting across all models. This section provides additional analyses examining the relationship between irrationality metrics and behavioral outcomes.
...
\textbf{Finding 1: Specific prompt components increase addiction risk}
...
\textbf{Finding 2: Information complexity drives irrational gambling behavior}
