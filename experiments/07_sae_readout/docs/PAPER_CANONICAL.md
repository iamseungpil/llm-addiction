...
| --- | --- | --- |
| Build paper-facing neural metrics manifest | `src/run_groupkfold_recompute.py` | Current strict-CV GroupKFold generator; `src/build_paper_neural_audit.py` is deprecated (moved to `legacy/v17_leaky_pipeline/`) |
...
| Paper neural figures | `src/plot_neural_figures.py` | Must read the strict-CV GroupKFold canonical files (Table 1 = `results/table1_groupkfold_L22.json`; Table 3 = `results/condition_modulation_groupkfold_L22.json`; Table 2 = `results/rq2_aligned_hidden_transfer_*L22_r1*.json`); no hard-coded paper numbers |
...
| Paper metrics manifest | Table 1 = `results/table1_groupkfold_L22.json`; Table 3 = `results/condition_modulation_groupkfold_L22.json`; Table 2 = `results/rq2_aligned_hidden_transfer_*L22_r1*.json` (strict-CV GroupKFold pipeline) | Generated canonical summary |
...
1. the strict-CV GroupKFold canonical files: Table 1 = `results/table1_groupkfold_L22.json`; Table 3 = `results/condition_modulation_groupkfold_L22.json`; Table 2 = `results/rq2_aligned_hidden_transfer_*L22_r1*.json`
2. the raw JSON/TXT artifact referenced inside those files
