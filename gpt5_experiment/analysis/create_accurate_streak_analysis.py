#!/usr/bin/env python3
"""
Create accurate streak analysis from GPT 3200 experiments
...
def load_gpt_data():
    """Load the correct GPT 3200 experimental data"""
    print("Loading GPT experimental data...")

    # Use the GPT 4.1 data file (3200 experiments)
    ...
    print(f"Experiment config: {data['experiment_config']}")
...
def main():
    print("=== ACCURATE STREAK ANALYSIS FOR GPT DATA (CORRECTED VERSION) ===")
    ...
    output_data = {
        ...
        'data_source': '/data/llm_addiction/gpt5_experiment/gpt5_experiment_20250921_174509.json',
        'total_experiments': len(experiments),
        'streak_results': streak_results,
        'comparisons': comparisons,
        'notes': 'Corrected version including stopped games with 0 bet change'
    }

    output_file = '/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_streak_analysis_results.json'
    ...
    korean_latex_file = '/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_streak_analysis_korean.tex'
    ...
    english_latex_file = '/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_streak_analysis_english.tex'
    ...
    # Print summary
    print(f"\n{'='*60}")
    print("CORRECTED STREAK ANALYSIS SUMMARY (INCLUDING STOPPED GAMES)")
    print(f"{'='*60}")
...
if __name__ == "__main__":
    ...
    print(f"\n✅ COMPLETED: Corrected streak analysis")
