...
def create_updated_component_figure(component_results):
    ...
    plt.savefig('/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_component_effects.pdf',
                dpi=300, bbox_inches='tight', format='pdf', facecolor='white', edgecolor='none')
    plt.savefig('/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_component_effects.png',
