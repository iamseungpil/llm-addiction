...
class BaseInvestmentExperiment(ABC):
    ...
    def __init__(self, model_name: str, bet_constraint: int, bet_type: str):
        ...
        # Results directory
        self.results_dir = Path('/data/llm_addiction/investment_choice_bet_constraint/results')
        self.results_dir.mkdir(parents=True, exist_ok=True)

        # Logs directory
        self.logs_dir = Path('/data/llm_addiction/investment_choice_bet_constraint/logs')
        self.logs_dir.mkdir(parents=True, exist_ok=True)

        # Checkpoints directory
        self.checkpoints_dir = Path('/data/llm_addiction/investment_choice_bet_constraint/checkpoints')
    ...
    def create_prompt(self, game: InvestmentGame, prompt_condition: str) -> str:
        ...
        if self.bet_type == 'fixed':
            ...
            prompt += f"Option 3: 25% chance of ${int(self.bet_constraint * 3.2)}, 75% chance of $0, continue\n"
