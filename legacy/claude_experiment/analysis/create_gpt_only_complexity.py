#!/usr/bin/env python3
"""
Create Claude-only complexity figure with statistical significance testing
"""
...
def create_claude_only_complexity_figure():
    """Create complexity figure with only Claude data and statistical tests"""
    print("Creating Claude-only complexity figure with statistical analysis...")
    ...
    print(f"Analyzing {total_loaded} Claude-3.5-Haiku experiments")
    ...
    claude_df = pd.DataFrame(claude_analysis)

    # Group by complexity and calculate metrics
    complexity_stats = []
    for complexity in sorted(claude_df['complexity'].unique()):
        subset = claude_df[claude_df['complexity'] == complexity]
    ...
    fig.suptitle('Claude-3.5-Haiku: Prompt Complexity Effects', fontsize=24, fontweight='bold')
    ...
    bankruptcy_counts = claude_df.groupby('complexity')['is_bankrupt'].sum()
    total_counts = claude_df.groupby('complexity').size()
    ...
    # Save figure
    output_path_pdf = '/home/ubuntu/llm_addiction/claude_experiment/results/claude_complexity_trend.pdf'
    output_path_png = '/home/ubuntu/llm_addiction/claude_experiment/results/claude_complexity_trend.png'
    ...
    print(f"\n✅ Claude-only complexity figure created with statistical analysis!")
...
if __name__ == "__main__":
    create_claude_only_complexity_figure()