#!/bin/bash
# Launch 12 parallel patching processes on GPUs 2,5,6,7 (3 each)
...
echo ""
echo "✅ Launched 12 processes on GPUs 2,5,6,7:"
echo "   GPU 2: L1-3, L4-6, L7-10"
echo "   GPU 5: L11-13, L14-16, L17-18"
echo "   GPU 6: L19-21, L22-24, L25"
echo "   GPU 7: L26-28, L29-30, L31"
echo ""
tmux ls | grep exp2_
