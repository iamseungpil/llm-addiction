...
# Phase 2: Correlation Analysis for GPU 5
# 50 features × 4 conditions = 200 analyses

PATCHING_FILE="/data/llm_addiction/experiment_pathway_token_analysis/results/phase1_patching/phase1_patching_multifeature_gpu5.jsonl"
...
# Extract unique target features from GPU 5's Phase 1 output
python3 << 'PYTHON_EOF' > /tmp/phase2_gpu5_features.txt
import json

filepath = "/data/llm_addiction/experiment_pathway_token_analysis/results/phase1_patching/phase1_patching_multifeature_gpu5.jsonl"
target_features = set()
...
done < /tmp/phase2_gpu5_features.txt

# Wait for all background jobs
wait

echo "GPU 5 Phase 2 complete!"
