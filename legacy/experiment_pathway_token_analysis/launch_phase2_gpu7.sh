...
# Phase 2: Correlation Analysis for GPU 7
# 50 features × 4 conditions = 200 analyses

PATCHING_FILE="/data/llm_addiction/experiment_pathway_token_analysis/results/phase1_patching/phase1_patching_multifeature_gpu7.jsonl"
...
# Extract unique target features from GPU 7's Phase 1 output
python3 << 'PYTHON_EOF' > /tmp/phase2_gpu7_features.txt
import json

filepath = "/data/llm_addiction/experiment_pathway_token_analysis/results/phase1_patching/phase1_patching_multifeature_gpu7.jsonl"
target_features = set()
...
done < /tmp/phase2_gpu7_features.txt

# Wait for all background jobs
wait

echo "GPU 7 Phase 2 complete!"
