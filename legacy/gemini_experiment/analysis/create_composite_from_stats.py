#!/usr/bin/env python3
"""
Create Composite Irrationality Index scatter plot for Gemini experiments
"""
...
def load_gemini_data_and_calculate_metrics():
    """Load Gemini data from multiple files and calculate actual I_EV, I_LC, I_EB metrics"""

    # Load only the complete 3200 experiment file (no test/incomplete data)
    data_files = [
        '/data/llm_addiction/gemini_experiment/gemini_experiment_20250920_042809.json',  # Main file: 3200 complete experiments
    ]
    ...
    print(f"Total loaded: {total_loaded} Gemini experiments")
    ...
    for experiment in all_experiments:
        ...
        for i, round_data in enumerate(game_history):
            ...
            # CORRECTED balance_before calculation for Gemini data
            if i == 0:
...
def create_four_panel_figure(conditions, output_path_pdf, output_path_png):
    ...
    fig.suptitle('Gemini-2.5-Flash Irrationality Analysis', fontsize=32, fontweight='bold', y=0.98)
...
if __name__ == "__main__":
    ...
    print("Loading Gemini data and calculating actual I_EV, I_LC, I_EB metrics...")

    # Load data and calculate metrics
    conditions = load_gemini_data_and_calculate_metrics()

    # Create 4-panel figure
    output_path_pdf = '/home/ubuntu/llm_addiction/gemini_experiment/results/gemini_irrationality_index.pdf'
    output_path_png = '/home/ubuntu/llm_addiction/gemini_experiment/results/gemini_irrationality_index.png'
