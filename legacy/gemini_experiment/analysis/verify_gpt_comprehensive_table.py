#!/usr/bin/env python3
"""
Verify Gemini comprehensive analysis table data
...
def load_gemini_data():
    """Load the Gemini experimental data from multiple files"""
...
def create_comprehensive_table():
    ...
    print("Creating comprehensive Gemini analysis table...")
    ...
    output_file = '/home/ubuntu/llm_addiction/gemini_experiment/results/gemini_comprehensive_analysis.json'
    ...
    latex_file = '/home/ubuntu/llm_addiction/gemini_experiment/results/gemini_comprehensive_table.tex'
    with open(latex_file, 'w') as f:
        f.write("\\begin{table}[ht!]\n")
        f.write("\\centering\n")
        f.write("\\caption{Gemini-2.5-Flash Gambling Experiment Results}\n")
        f.write("\\label{tab:gemini-comprehensive}\n")
