...
def create_gpt_only_complexity_figure():
    ...
    # Load GPT 4.1 data (3,200 experiments)
    with open('/data/llm_addiction/gpt5_experiment/gpt5_experiment_20250921_174509.json') as f:
        gpt_data = json.load(f)

    print(f"Analyzing {len(gpt_data['results'])} GPT-4.1-mini experiments")
    ...
    # Save figure
    plt.savefig('/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_complexity_trend.pdf',
                dpi=300, bbox_inches='tight')
    plt.savefig('/home/ubuntu/llm_addiction/gpt5_experiment/results/gpt41_complexity_trend.png',
                dpi=300, bbox_inches='tight')
    plt.close()
