#!/usr/bin/env python3
"""GPT-4o-mini Runner for Extended Investment Choice Experiment"""
...
class GPT4oRunner(BaseInvestmentExperiment):
    ...
    def __init__(self, bet_constraint, bet_type: str):
        super().__init__('gpt4o_mini', bet_constraint, bet_type)
    ...
    def get_model_response(self, prompt: str) -> str:
        """Get response from GPT-4o-mini with retry logic"""
        attempt = 1
