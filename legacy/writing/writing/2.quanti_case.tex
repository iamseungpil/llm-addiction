...
This section presents comprehensive experimental results from both paradigms. Table~\ref{tab:slot-machine-results} summarizes the slot machine experiment outcomes across six LLMs, reporting bankruptcy rates, irrationality indices, average rounds played, total bet amounts, and net profit/loss for both fixed and variable betting conditions. Table~\ref{tab:investment-choice-results} presents the investment choice experiment results for four API-based models, showing Option 4 selection rates (as an irrationality indicator), average rounds, total bets, and net outcomes.
...
\subsection{Irrationality-Bankruptcy Correlation Analysis}
...
As reported in Table~\ref{tab:multi-model-comprehensive} of Section~\ref{sec:3}, variable betting consistently produced higher bankruptcy rates than fixed betting across all models. This section provides additional analyses examining the relationship between irrationality metrics and behavioral outcomes.
...
\textbf{Finding 4: Autonomy drives addiction independent of bet magnitude}
