...
- Panel (b): Option Distribution by Prompt Condition
- Panel (c): Goal Escalation by Prompt Condition
- Panel (d): Bankruptcy Rate by Bet Constraint (Fixed vs Variable)

Key insight: Variable betting consistently shows higher bankruptcy than Fixed
across ALL bet constraints, demonstrating betting flexibility as a robust risk factor.
"""
...
def create_figure(stats):
    """Create 4-panel figure (1x4 horizontal layout for consistency with other figures)"""
    ...
    # ==========================================
    # Panel (a): Bankruptcy Rate by Prompt
    # ==========================================
    ax = axes[0]
    ...
    # ==========================================
    # Panel (b): Option Distribution by Prompt
    # ==========================================
    ax = axes[1]
    ...
    ax.set_title('(b) Option Distribution')
    ax.set_xticks(x_prompts)
    ax.set_xticklabels(prompts)
    ax.set_ylim(0, 100)
    ax.spines['top'].set_visible(False)
    ...
    # ==========================================
    # Panel (c): Goal Escalation by Prompt
    # ==========================================
    ax = axes[2]
    ...
    ax.set_title('(c) Goal Escalation')
    ax.set_xticks(x_prompts)
    ax.set_xticklabels(prompts)
    ax.set_ylim(0, 70)
    ax.spines['top'].set_visible(False)
    ...
    # ==========================================
    # Panel (d): Bankruptcy Rate by Bet Constraint
    # ==========================================
    ax = axes[3]
...
def main():
    print("=" * 60)
    print("INVESTMENT CHOICE 4-PANEL FIGURE")
    print("=" * 60)
    ...
    fig.savefig(f'{output_dir}/investment_choice_4panel.png',
                dpi=300, bbox_inches='tight', facecolor='white')
    fig.savefig(f'{output_dir}/investment_choice_4panel.pdf',
                bbox_inches='tight', facecolor='white')

    print(f"\nFigures saved to:")
    print(f"  - {output_dir}/investment_choice_4panel.png")
    print(f"  - {output_dir}/investment_choice_4panel.pdf")
    plt.close()
