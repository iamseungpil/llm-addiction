...
**[W3]** Accepted, in the form that answers the question: every body figure gains its n and a 95% interval, and for arm comparisons we report the interval on the **difference** rather than leaving it to be inferred from two marginal intervals. Effect sizes with their uncertainty go where a bare p stands — Finding 5's keyword scan and the SAE appendix table.
