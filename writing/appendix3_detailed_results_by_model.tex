...
\begin{itemize}
    ...
    \item The Irrationality Index for Claude-3.5-Haiku has a near-perfect correlation of $r = 0.842$, indicating that each added component consistently increased irrational decision-making.
\end{itemize}
